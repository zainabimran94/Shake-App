  ...
  <div class="relative z-0 bg min-h-screen">
      <div class="container py-16 sm:py-0">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 place-items-center min-h-[600px]">
          <h1 id="shakeText" class="font-semibold font-cursive text-5xl text-center sm:text-left px-3">{{ shakeName }} Milkshake</h1>
           <div id="svg" >
                 <svg data-aos="zoom-in" class="flex flex-col jusity-end items-center relative order-1 md:order-2" width="325" height="682" viewBox="0 0 325 682" fill="none" xmlns="http://www.w3.org/2000/svg">
